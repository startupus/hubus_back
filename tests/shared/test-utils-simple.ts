...
export class TestUtils {
  ...
  static mockLoggerUtil() {
    jest.spyOn(LoggerUtil, 'info').mockImplementation(() => {});
    jest.spyOn(LoggerUtil, 'warn').mockImplementation(() => {});
    jest.spyOn(LoggerUtil, 'error').mockImplementation(() => {});
    jest.spyOn(LoggerUtil, 'debug').mockImplementation(() => {});
  }
