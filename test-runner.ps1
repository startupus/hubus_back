...
if ($Help) {
    Write-Host "Usage: .\test-runner.ps1 [options]" -ForegroundColor Yellow
    Write-Host ""
    ...
    Write-Host "  .\test-runner.ps1                           # Run all tests" -ForegroundColor White
    Write-Host "  .\test-runner.ps1 -TestType unit           # Run only unit tests" -ForegroundColor White
    Write-Host "  .\test-runner.ps1 -Service auth            # Run tests for auth service" -ForegroundColor White
    Write-Host "  .\test-runner.ps1 -Coverage -Verbose       # Run with coverage and verbose output" -ForegroundColor White
    Write-Host "  .\test-runner.ps1 -Watch                   # Run in watch mode" -ForegroundColor White
    exit 0
}
