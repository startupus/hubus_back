...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Check if service is ready' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Service readiness check' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Service liveness check' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
