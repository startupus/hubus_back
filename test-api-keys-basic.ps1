...
Write-Host "=== API KEYS BASIC TEST ===" -ForegroundColor Green

# Generate unique email
$timestamp = Get-Date -Format "yyyyMMddHHmmss"
$companyEmail = "apikey-basic-$timestamp@example.com"

# Register company
$companyData = @{
    name = "API-Key-Basic-Company"
    email = $companyEmail
    password = "password123"
    description = "Company for basic API key testing"
} | ConvertTo-Json
...
$apiKeyData = @{
    ...
    description = "API key for basic testing"
...
# Update API key
$updateData = @{
    name = "Updated Basic Test API Key"
