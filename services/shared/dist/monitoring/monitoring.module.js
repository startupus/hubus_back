...
exports.MonitoringModule = MonitoringModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [api_monitor_service_1.ApiMonitorService, health_check_service_1.HealthCheckService],
        exports: [api_monitor_service_1.ApiMonitorService, health_check_service_1.HealthCheckService],
    })
], MonitoringModule);
