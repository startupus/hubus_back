# Test token separation directly in billing service
Write-Host "=== TOKEN SEPARATION TEST ===" -ForegroundColor Cyan

# Get token from browser localStorage
$token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxZDllYTQ0OS1kY2YtNDdhMy05YmE5LTZmOGU1MmFjOWFhYyIsImVtYWlsIjoidGVzdEBleGFtcGxlLmNvbSIsImlhdCI6MTcyOTAwNzQwMCwiZXhwIjoxNzI5MDkzODAwfQ.example"
