...
Test-Endpoint "API-Gateway" "GET" "$baseUrl:3000/v1/models"
Test-Endpoint "API-Gateway" "GET" "$baseUrl:3000/v1/models/providers"
Test-Endpoint "API-Gateway" "GET" "$baseUrl:3000/v1/models/categories"
