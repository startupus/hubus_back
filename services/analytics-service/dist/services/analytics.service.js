...
let AnalyticsService = AnalyticsService_1 = class AnalyticsService {
    ...
    async getAnalyticsEvents(request) {
        try {
    ...
    async updateAIAnalytics(modelId, provider, data) {
        try {
    ...
    async getDashboardData(userId) {
        try {
            ...
            const [summary, charts, recentActivity, alerts, recommendations] = await Promise.all([
    ...
    async calculateMetricsSummary(where) {
    ...
    async calculateMetricsTrends(where) {
        const now = new Date();
    ...
    mapToUserAnalytics(prismaUserAnalytics) {
        return {
    ...
    mapToAIAnalytics(prismaAIAnalytics) {
        return {
